...
נוצר 2026-08-10 17:56 · `scripts/generate_open_tasks_digest.sh`

🔴 מאיים על חלון-המדידה · 🟠 חוסם עבודה אחרת · 🟡 יכול לחכות
`שער` = יש קריטריון-סגירה מדיד · `↘N` = כמה תיקים פתוחים מפנים אליו

## הדחופים (8)
- 🔴 **TASK-209** (42d) Retire calculate_score or demote to logged diagnostic (~15 consumers)
- 🔴 **TASK-259** (5d) agent_minute runs overlap — account state snapshot is stale by design
- 🔴 **TASK-194** (47d) ADR-009 post-flip monitoring: track active-mode entries vs Score-gated
- 🔴 **TASK-276** (2d) Portfolio heat cap - block new ENTERs above the configured ceiling
- 🔴 **TASK-279** (2d) Recompute Quantity and PositionSizeUSD at the live-price override
- 🔴 **TASK-280** (2d) pip install is ~90% of every agent_minute run — cache or split require
- 🔴 **TASK-301** (0d) Single-entry cap leaks between concurrent runs - snapshot TOCTOU
- 🔴 **TASK-296** (0d) Rotate the exposed ridinghigh-sheets-v2 service account key on 2026-08
...
TASK-194 | ADR-009 post-flip monitoring: track active-mode entries vs Score-gated baseline (flip e… | 47d | 🔴 | ✅ | ↘1
...
TASK-230 | Data-gap audit + enrichment for peak-signature research (volume-fade, halts, premarket, f… | 37d | 🟠 | ✅ | ↘2
...
TASK-267 | check_06 samples 50 runs, a 24-minute window, and returns INFO when everything is queued | 4d | 🟠 | ✅ | ↘2
TASK-277 | Build gate 6 - no aggregate includes a non-CLEAN row | 2d | 🟠 | ❌ | ↘2
TASK-71 | ניתוח 'הצד השני' — מכל המניות שתועדו (לא רק 104 שנכנסו): אילו ירדו/עלו הכי הרבה ואילו מדד… | 71d | 🟠 | ❌ | ↘1
...
TASK-234 | auto-dancer: PLANNER plan.md write-path blocked by night allow-list -> execute-proof (186… | 36d | 🟠 | ❌ | ↘1
TASK-101 | התקנת security-guidance plugin + אימות אי-התנגשות עם skill-gate hook | 69d | 🟠 | ❌ | ↘0
TASK-225 | Hold-window research: D1-D25 optimal holding analysis — decision blocked until HYP-002 co… | 37d | 🟠 | ✅ | ↘0
TASK-235 | auto-dancer: classify_verdict claude -p gets empty stdin -> 'Input must be provided...' -… | 36d | 🟠 | ❌ | ↘0
TASK-237 | auto-dancer token ceiling not enforced WITHIN a run -> single task burned 2.8M tokens (… | 36d | 🟠 | ❌ | ↘0
...
TASK-306 | Ruling needed: does an enforcement-duplicate count as a reentry-cap breach under HYP-002 … | 0d | 🟠 | ✅ | ↘0
...
TASK-65 | פער postmortems: 9 פוזיציות סגורות ללא postmortem (104 vs 95). לזהות אילו ולהחליט אם לשח… | 71d | 🟡 | ✅ | ↘1
...
TASK-229 | HYP-004-draft: late-entry (>=15:30 ET) forward research — thesis, criterion, falsifiers | 37d | 🟡 | ✅ | ↘1
...
TASK-73 | הרחבת CRITIC במודול ניתוח-עומק (מתודולוגיית TASK-62) — אוטומציה שבועית/חודשית של הניתוח ה… | 71d | 🟡 | ❌ | ↘0
...
TASK-222 | dashboard.py:1928 _is_day_complete duplicates utils.is_day_complete — consolidate to sing… | 39d | 🟡 | ❌ | ↘0
TASK-236 | auto-dancer VERIFY produces empty verify.json -> task_result=stage_error (execute-proof… | 36d | 🟡 | ❌ | ↘0
...
TASK-307 | 429 monitor command flips direction between closed and open days - index instead of time… | 0d | 🟡 | ✅ | ↘0
TASK-309 | Four doc alignments: TASK-248 title, TASK-128 title+status, WORK_PLAN 259, concurrency com… | 0d | 🟡 | ✅ | ↘0

## חוב: 42/88 תיקים בלי שער-קבלה מדיד (47%)
TASK-209 TASK-259 TASK-276 TASK-279 TASK-215 TASK-244 TASK-186 TASK-246 TASK-153 TASK-252 TASK-253 TASK-255 TASK-277
TASK-71 TASK-74 TASK-234 TASK-101 TASK-235 TASK-237 TASK-258 TASK-39 TASK-49 TASK-226 TASK-248 TASK-250 TASK-257
TASK-261 TASK-73 TASK-216 TASK-222 TASK-236 TASK-241 TASK-243 TASK-249 TASK-260 TASK-264 TASK-271 TASK-272 TASK-273
